...
<head>
    ...
    <title>Edupro - School Management System</title>
...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="index.html">Edupro</a></h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                    ...
                    <h2>We are team of talented developers to develop school management for you</h2>
                    <div class="d-flex justify-content-center justify-content-lg-start">
                        <a href="{{ url('/school-registration') }}" class="btn-get-started scrollto">Get Started</a>
    ...
    <footer id="footer">
        ...
        <div class="container footer-bottom clearfix">
            ...
            <div class="credits">
                ...
                Designed by <a href="#">Bipin Regmi</a>
            </div>
        </div>
    </footer><!-- End Footer -->
