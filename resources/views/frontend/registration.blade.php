...
@section('content')
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12 pt-3 mt-5">
                <div class="alert alert-info">Email and Password Entered Will be considered as the school admin password
                </div>
            </div>
            <div class="col-md-12 mb-5">
                <div class="card">
                    <form action="{{ route('schools.register') }}" method="post">
                        @csrf
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" va class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                    name="name" placeholder="{{ __('School Full Name') }}" id="name"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nickname"
                                    ...
                                    placeholder="{{ __('School Nick Name') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="password" id="password"
                                        ...
                                        name="password" placeholder="{{ __('School Account Password') }}"
                                        value="{{ isset($school) ? old('password', $school->password) : old('password', '') }}">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="number" id="contact" minlength="10" maxlength="10"
                                        ...
                                        name="contact" placeholder="{{ __('School Contact') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" id="owner_name"
                                        ...
                                        name="owner_name" placeholder="{{ __('School Email') }}"
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="number" id="owner_contact"
                                        ...
                                        name="owner_contact" placeholder="{{ __('School Owner Contact') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" id="principle_name"
                                        class="form-control {{ $errors->has('principle_name') ? 'is-invalid' : '' }}"
                                        name="principle_name" placeholder="{{ __('Principle Name') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="number" id="tution_fee"
                                                class="form-control {{ $errors->has('tution_fee') ? 'is-invalid' : '' }}"
                                                name="tution_fee" placeholder="{{ __('Tution Fee') }}"
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="number" id="sports_fee"
                                                class="form-control {{ $errors->has('sports_fee') ? 'is-invalid' : '' }}"
                                                name="sports_fee" placeholder="{{ __('Sport Fee') }}"
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            @if ($errors->has('transportation_fee'))
                                                <span
                                                    class="text-danger">{{ $errors->first('transportation_fee') }}</span>
                                            @endif
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="food_fee">{{ __('Food Fee *') }}</label>
                                            <input type="number" id="food_fee"
                                                class="form-control {{ $errors->has('food_fee') ? 'is-invalid' : '' }}"
                                                name="food_fee" placeholder="{{ __('Food Fee') }}"
                    ...
                    <form action="https://uat.esewa.com.np/epay/main" method="POST">
                        ...
                        <input value="http://merchant.com.np/page/esewa_payment_success?q=su" type="hidden"
                            name="su">
                        <input value="http://merchant.com.np/page/esewa_payment_failed?q=fu" type="hidden"
                            name="fu">
                        <input value="Demo Esewa Integrate" type="submit">
                    </form>
                </div>
            </div>
        </div>
